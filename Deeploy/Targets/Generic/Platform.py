...
from Deeploy.Targets.Generic.Bindings import BasicAddBindings, BasicConcatBindings, BasicConv1DBinding, \
    ...
    BasicSliceBindings, BasicSoftmaxBindings, BasicTransposeBindings, DummyBinding, BasicLIFBindings, BasicLIFstatefulBindings
from Deeploy.Targets.Generic.Layers import AddLayer, ConcatLayer, ConvLayer, DebugPrintLayer, DequantLayer, DivLayer, \
    ...
    RQSiGELULayer, SliceLayer, SoftmaxLayer, TransposeLayer, LIFLayer, LIFstatefulLayer
...
LIFMapper = NodeMapper(LIFParser(), BasicLIFBindings)
LIFstatefulMapper = NodeMapper(LIFstatefulParser(), BasicLIFstatefulBindings)
...
GenericMapping = {
    ...
    'LIF': LIFLayer([LIFMapper]),
    'LIF_stateful': LIFstatefulLayer([LIFstatefulMapper]),
