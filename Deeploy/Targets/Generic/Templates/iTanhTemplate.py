...
class _iTanhTemplate(NodeTemplate):
...
referenceTemplate = _iTanhTemplate("""
// iTanh (Name: ${nodeName}, Op: ${nodeOp})
SINGLE_CORE Tanh_s8_s8(${data_in}, ${data_out}, ${size}, ${input_offset}, ${output_offset}, ${input_scale_mult}, ${input_scale_shift}, ${output_scale_mult}, ${output_scale_shift});
""")
