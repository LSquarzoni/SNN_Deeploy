# ----------------------------------------------------------------------
#
# File: FloatLIFstatefulTemplate.py
#
...
class _FloatLIFStatefulTemplate(NodeTemplate):
...
referenceTemplate = _FloatLIFStatefulTemplate("""
// LIF stateful (Name: ${nodeName}, Op: ${nodeOp})
